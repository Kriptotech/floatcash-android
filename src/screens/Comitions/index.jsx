...
export function Comitions({ navigation }) {
    ...
    async function getComitions() {
        ...
        await fetch(`${server_url}/comitions/get_all_confirmed_comitions`)
            .then((res) => res.json())
            .then((data) => {
                setIsLoading(false);
    ...
    return (
        <View style={styles.dashboard_container}>
            ...
            {showH1 && (
                <Text style={styles.strong}>Comissões confirmadas:</Text>
            )}
                    ...
                    {comitions?.map((v, i) => {
                        return (
                            <TouchableOpacity
                                ...
                                onPress={() =>
                                    navigation.navigate("comition", v)
                                }
                            >
