...
export function RegisterAgentSupervisor({ navigation }) {
    ...
    async function registerAgent() {
        ...
        await fetch(`${server_url}/users/register_agent_supervisor`, {
            method: "POST",
                ...
                <View style={styles.login_container}>
                    <View style={styles.login_box}>
                        <Text style={styles.login_h1}>
                            Registrar supervisor de agentes
                        </Text>
                        <Text style={styles.p}>
                            Preencha os dados para adicionar um supervisor de
                            agentes
                        </Text>

                        {/* INPUTS  */}
                        <Text style={styles.span}>
                            Nome do supervisor de agentes
                        </Text>
                        <TextInput
                            style={styles.input}
                            value={username}
                        ...
                        />
                        <Text style={styles.span}>
                            Nome do operador do supervisor de agentes{" "}
                        </Text>
                        <TextInput
                            style={styles.input}
                            value={operator_name}
                        ...
                        />
                        <Text style={styles.span}>
                            Numero de celular do supervisor de agentes{" "}
                        </Text>
                        <TextInput
                            style={styles.input}
                        ...
                        />
                        <Text style={styles.span}>
                            Palavra passe do supervisor de agentes{" "}
                        </Text>
                        <TextInput
                            style={styles.input}
                            value={password}
