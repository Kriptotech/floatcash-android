...
export function AgentBox({
    ...
    return (
        <>
            <View style={[styles.first_row_item, styles.first_row_item_large]}>
            ...
            {/* <View style={styles.first_row_item}>
                <View style={styles.circle}>
                    <Text style={styles.p_circle_text}>
                        {isLoading ? <ActivityIndicator color={"#fff"} size={"small"}/> : unConfirmedMoneyRequests.length < 1
                            ? 0
            ...
            <View style={styles.first_row_item}>
                <View style={styles.circle}>
                    <Text style={styles.p_circle_text}>
                        {isLoading ? <ActivityIndicator color={"#fff"} size={"small"}/> : confirmedMoneyRequests.length < 1
                            ? 0
